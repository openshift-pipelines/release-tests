...
func ExposeDeploymentConfig(c *clients.Clients, elname, namespace string) string {
	cmd.MustSucceed("oc", "expose", "dc/"+elname, "-n", namespace, "--target-port=3000")
	cmd.MustSucceed("oc", "expose", "svc", elname, "-n", namespace, "--target-port=3000")
