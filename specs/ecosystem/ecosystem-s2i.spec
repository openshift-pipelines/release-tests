...
Steps:
  ...
  * Create
      |S.NO|resource_dir                                                 |
      |----|-------------------------------------------------------------|
      |1   |testdata/ecosystem/pipelines/nodejs.yaml                     |
      |2   |testdata/pvc/pvc.yaml                                        |
      |3   |testdata/ecosystem/configmaps/s2i-nodejs.yaml                |
      |4   |testdata/ecosystem/pipelineruns/s2i-nodejs-pipelinerun.yaml  |
  * Verify pipelinerun
      |S.NO|pipeline_run_name|status     |check_lable_propagation|
      |----|-----------------|-----------|-----------------------|
      |1   |nodejs-ex-git-pr |successful |no                     |
  * Expose Deployment config "nodejs-ex-git"
  * Get route url of the route "nodejs-ex-git"
  * Validate route url which contains "See Also"
