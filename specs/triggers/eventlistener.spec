...
Steps:
  ...
  * Verify "triggerbinding" "pipeline-binding" exists
  * Verify "triggertemplate" "pipeline-template" exists
  * Verify "eventlistener" "listener-embed-binding" exists
...
Steps:
  ...
  * Verify "triggerbinding" "gitlab-push-binding" exists
  * Verify "triggertemplate" "gitlab-echo-template" exists
  * Verify "eventlistener" "gitlab-listener" exists
...
Steps:
  ...
  * Verify "triggerbinding" "bitbucket-binding" exists
  * Verify "triggertemplate" "bitbucket-template" exists
  * Verify "eventlistener" "bitbucket-listener" exists
...
Steps:
  ...
  * Verify "triggertemplate" "pipeline-template-git-push" exists
  * Verify "eventlistener" "listener-ctb-github-push" exists
...
Steps:
  ...
  * Verify "triggertemplate" "pipeline-template-git-pr" exists
  * Verify "eventlistener" "listener-clustertriggerbinding-github-pr" exists
  * Verify "clustertriggerbinding" "github-pullreq" exists
  * Create & Link secret "github-secret" to service account "pipeline"
...
Steps:
  ...
  * Verify "triggertemplate" "pipeline-template-git-pr-review" exists
  * Verify "eventlistener" "listener-ctb-github-pr-review" exists
  * Verify "clustertriggerbinding" "github-pullreq" exists
  * Create & Link secret "github-secret" to service account "pipeline"
...
Steps:
  ...
  * Verify "triggerbinding" "github-pr-binding" exists
  * Verify "triggertemplate" "github-template" exists
  * Verify "eventlistener" "listener-triggerref" exists
  * Create & Link secret "github-secret" to service account "pipeline"
