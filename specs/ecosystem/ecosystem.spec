...
Steps:
  ...
  * Create
      |S.NO|resource_dir                                     |
      |----|-------------------------------------------------|
      |1   |testdata/ecosystem/secrets/github-auth-token.yaml|
      |2   |testdata/ecosystem/pipelines/pull-request.yaml   |
      |3   |testdata/pvc/pvc.yaml                            |
      |4   |testdata/ecosystem/pipelineruns/pull-request.yaml|
  * Verify pipelinerun
      |S.NO|pipeline_run_name                  |status      |check_label_propagation  |
      |----|-----------------------------------|--------------------------------------|
